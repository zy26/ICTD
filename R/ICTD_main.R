...
#tg_selected_R4_RR<-select_R_base(tg_selected_R4,tg_possible_base_ids)
...
#tg_selected_R4_RR<-select_R_base(CTES,tg_possible_base_ids)
tg_selected_R4_RR<-NMF_selected_R1



#ICTD
#qnmf_result<-NMF_method1_test_version2(tg_list=tg_selected_R4_RR,data_ng=data.matrix0_s,data_normalized=data_23_s, max_ES_cut=0.3,tProp=tProp,NMF_RR=10)
#qnmf_result<-NMF_method1_test_version2(tg_list=NMF_selected_R1,data_ng=data.matrix0_s,data_normalized=data_23_s, max_ES_cut=0.3,tProp=tProp,NMF_RR=10)
qnmf_result<-NMF_method1_test_version3(tg_list=NMF_selected_R1,data_ng=data.matrix0_s,data_normalized=data_23_s, max_ES_cut=0.3,tProp=tProp,NMF_RR=10)
